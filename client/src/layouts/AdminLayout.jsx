...
import {
  ...
  TrendingDown, Zap, BarChart2, Settings, Building2,
} from "lucide-react";
...
const AdminLayout = () => {
  ...
  // Resolved branding — live from tenant settings, falls back gracefully
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      {/* ── Mobile top bar ── */}
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-100
        ...
        <div className="flex items-center gap-2">
          <img
            src={logoSrc}
            alt={businessName}
            className="w-7 h-7 rounded-lg object-contain bg-gray-50"
            onError={(e) => { e.currentTarget.src = defaultLogo; }}
          />
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 py-2.5 text-sm font-semibold rounded-xl border border-gray-200
              ...
              <button
                ...
                className="flex-1 py-2.5 text-sm font-semibold rounded-xl bg-red-500
