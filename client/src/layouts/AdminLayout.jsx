    ...
    <div className="flex flex-col h-full">
      <div className="px-5 pt-7 pb-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <img src={logo} alt="Dairy" className="w-10 h-10 rounded-xl object-cover flex-shrink-0" />
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-100 px-4 py-3 flex items-center justify-between z-40 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          <img src={logo} alt="Dairy" className="w-7 h-7 rounded-lg object-cover" />
      ...
      {confirmLogout && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
            ...
            <p className="text-sm text-gray-600 mt-1">You will need to log in again to access the dashboard.</p>
