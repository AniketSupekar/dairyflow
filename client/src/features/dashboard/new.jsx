...
import {
  ...
  RefreshCw, TrendingUp, ChevronRight, Radio, Clock,
  XCircle, Umbrella,
} from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const fetchLiveDelivery = async (silent = false) => {
    ...
    try {
      ...
      // fail silently on dashboard — not a blocker
    } finally {
      ...
      <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-50">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 bg-green-50 border border-green-200 text-green-700 text-[10px] font-bold px-2 py-0.5 rounded-full">
